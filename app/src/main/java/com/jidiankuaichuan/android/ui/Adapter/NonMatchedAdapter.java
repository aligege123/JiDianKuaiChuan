...
public class NonMatchedAdapter extends ArrayAdapter<BluetoothDevice> {
    private int resourceId;

    public NonMatchedAdapter(Context context, int textViewResourceId, List<BluetoothDevice> objects) {
